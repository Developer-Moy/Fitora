...
GET(All Meals) <http://localhost:5000/api/meals/getMeals>

GET <http://localhost:5000/api/meals/getMeals?goal=weight-loss&caloriesMin=300&caloriesMax=400&dietaryTags=high-protein>

GET <http://localhost:5000/api/meals/getMeals?goal=muscle-gain&dietaryTags=high-protein&prepTime=30>

GET <http://localhost:5000/api/meals/getMeals?goal=weight-loss&caloriesMin=300&caloriesMax=500&prepTime=30&dietaryTags=high-protein,low-carb>

GET <http://localhost:5000/api/meals/getMeals?goal=maintenance&dietaryTags=vegan,gluten-free>

### Detailed View including ingredient list, and macro breakdown (Protein, Carbs, Fats)

GET <http://localhost:5000/api/meals/6a900055238a668c7442cb6d>
...
GET <http://localhost:5000/api/meal-charts/getMealCharts?userId=user_123>

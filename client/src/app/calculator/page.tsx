...
type CalculatorTab = "bmi" | "nutrition";
...
- Fats: ${macros.fats}g (${macroPercentages.fats}%)`;
  ...
  return (
    <div className="w-full bg-black text-white selection:bg-white selection:text-black">
      ...
      ====================================================== */}
      {activeTab === "bmi" && (
        <section className="bg-black px-4 pt-6 sm:pt-10 pb-12 text-white sm:px-6 lg:pt-8 lg:pb-16 select-none ">
          <div className="mx-auto w-11/12 max-w-7xl">
            <div className="grid gap-8 lg:grid-cols-12 lg:items-stretch">
              ...
              <div className="flex flex-col justify-between lg:col-span-6 space-y-5">
                ...
                <div className="group relative h-55 sm:h-65 lg:h-67.5 my-auto overflow-hidden rounded-2xl border border-white/15 shadow-2xl">
                  <img
      ...
      ====================================================== */}
      {activeTab === "nutrition" && (
        <section className="bg-black px-4 py-12 sm:px-6 lg:py-16 select-none">
          <div className="mx-auto w-11/12 max-w-7xl">

  ...
  return (
    <div className="space-y-6">
      ...
      <InvoiceModal
        ...
        athleteName={athleteName || activeInvoice?.userName}
        athleteEmail={athleteEmail || activeInvoice?.userEmail}
        athletePhone={athletePhone || activeInvoice?.userPhone}
        assignedBranch={assignedBranch || activeInvoice?.branch}
      />
    </div>
  );
}

...
export default function MacroAdjuster({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-neutral-950 p-5 sm:p-6 shadow-xl mt-3">
      {!isPremium && (
        <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/75 backdrop-blur-[3px]">
          <div className="mx-4 max-w-sm rounded-2xl border border-white/15 bg-neutral-900 p-5 text-center shadow-2xl">
            ...
            <p className="mt-2 text-[11px] leading-relaxed text-gray-400">
              Premium members can customize their protein, carbs and fat
              ratios for a personalized nutrition target.
            </p>

            <a
              href="/pricing"
              className="mt-4 inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-[10px] font-black uppercase tracking-wider text-black transition hover:bg-gray-200"
            >
      ...
      <div className={!isPremium ? "opacity-40" : ""}>
        <div className="mb-5 flex items-start justify-between gap-3 border-b border-white/10 pb-4">
          ...
          <div className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[9px] font-black text-gray-300">
            {total}%
          </div>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              disabled={!isPremium}
              onChange={(e) =>
                handleChange("protein", Number(e.target.value))
              }
          ...
          <div>
            ...
            <input
              ...
              disabled={!isPremium}
              onChange={(e) =>
                handleChange("carbs", Number(e.target.value))
              }
              className="h-1.5 w-full cursor-pointer appearance-none rounded-full bg-white/10 accent-white disabled:cursor-not-allowed"
            />
          </div>

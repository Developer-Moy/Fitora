      ...
      >
        ...
        <div className="relative flex h-16 items-center border-b border-white/[0.08]">
          ...
          >
            ...
            <span
              className={`text-xl font-extrabold tracking-wider text-white whitespace-nowrap transition-opacity duration-200 ${
                showDetails
                  ? "opacity-100"
          ...
          <button
            ...
            className={`hidden lg:flex h-7 w-7 items-center justify-center rounded-lg border border-white/10 bg-[#141519] text-white/60 hover:text-white hover:border-red-500/50 shadow-md transition-all duration-200 z-10 ${
              isCollapsed
        ...
        >
          {navItems.map((group, groupIdx) => (
            <div key={groupIdx} className="space-y-1">
              <p
                className={`px-3 text-[10px] font-extrabold tracking-widest text-white/40 uppercase whitespace-nowrap transition-opacity duration-200 ${
                  showDetails
                    ? "opacity-100"
              ...
              {group.links.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {item.isAi && (
                      <span
                        className={`ml-auto rounded-full bg-purple-950/50 px-2 py-0.5 text-[10px] font-bold text-purple-400 border border-purple-800/40 flex items-center gap-1 transition-opacity duration-200 ${
                          showDetails
                            ? "opacity-100"
                            : "opacity-0 w-0 overflow-hidden pointer-events-none"
                        }`}
          ...
          >
            ...
            >
              ...
              <p className="truncate text-xs text-red-400 font-medium flex items-center gap-1">
                <span className="w-1.5 h-1.5 rounded-full bg-red-500" /> Pro Athlete
              </p>
            </div>
          </div>
        </div>

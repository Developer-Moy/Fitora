...
export const TimeDisplay: React.FC<TimeDisplayProps> = ({
  ...
  return (
    <>
      {/* Glowing Circular Progress Ring Around the Display */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none z-10 w-[270px] h-[270px] sm:w-[310px] sm:h-[310px] flex items-center justify-center">
      ...
      <div className="flex flex-col items-center justify-center my-2 md:my-0">
        {/* Main Digits */}
        <div className="text-4xl sm:text-6xl md:text-7xl font-extrabold font-mono tracking-tight text-white drop-shadow-[0_2px_12px_rgba(255,255,255,0.15)]">
          {formatTime(seconds)}
        </div>

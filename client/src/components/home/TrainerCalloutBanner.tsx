...
export default function TrainerCalloutBanner() {
  return (
    <section className="relative w-full bg-black text-white rounded-t-[3rem] rounded-b-[3rem] sm:rounded-t-[4.5rem] sm:rounded-b-[4.5rem] py-16 sm:py-24 px-6 sm:px-10 lg:px-16 overflow-hidden select-none border-t border-b border-white/10">

...
export default function WhyChooseUs() {
  return (
    <section id="why-choose" className="w-full bg-white py-6 sm:py-8 px-4 sm:px-6 lg:px-10 select-none">
      <div className="max-w-7xl mx-auto rounded-[2.5rem] sm:rounded-[3.5rem] bg-black text-white p-8 sm:p-14 lg:p-20 shadow-2xl border border-white/10">

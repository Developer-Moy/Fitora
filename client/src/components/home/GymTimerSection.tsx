...
export default function GymTimerSection() {
  return (
    <section
      id="gym-timer"
      className="py-16 px-6 md:px-10 border-t border-white/[0.06]"
    >
      ...
      <div className="min-h-[400px] rounded-2xl border border-dashed border-red-500/20 flex items-center justify-center">
      <StopwatchPage/>
      </div>
    </section>
  );

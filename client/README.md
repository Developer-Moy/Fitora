...
| `/book-session`        | **Session Booking**            | Optional Auth | Dynamic 1-on-1 session booking system with real-time overlapping slot prevention and automated NodeMailer trainer confirmation emails.                                            |
